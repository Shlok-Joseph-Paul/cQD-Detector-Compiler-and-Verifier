...
function csvRow(record: AtlasRecord): Array<string | number | null> {
  return [
    ...
    record.device.ligandExchangeStatus,
    record.device.ligandExchangeType,
    record.device.ligandExchangeChemicals,
    record.device.nativeLigands,
    record.device.ligandExchangeTarget,
