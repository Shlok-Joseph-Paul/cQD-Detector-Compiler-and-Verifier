...
const records: JoinedMeasurement[] = [
  {
    ...
    measurement: {
      ...
      flag: "amber",
      amber_reasons: ["missing_temperature"],
      amber_explanation: "Temperature was not reported.",
      curator_notes: null,
  ...
  },
  {
    ...
    measurement: {
      ...
      curator_status: "reviewed",
      flag: "amber",
      amber_reasons: ["shot_noise_approximation", "preprint"],
      amber_explanation: "Shot-noise estimate in a preprint.",
      curator_notes: null,
      date_added: "2025-01-01",
      date_updated: "2025-01-01",
    },
